...
url: "https://www.keycloak.org/2026/04/scim-as-experimental-feature"
...
<div class="content">
<pre class="highlight"><code class="language-bash">docker run --name kc-scim-api -d \
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">./kcadm.sh config credentials --server http://localhost:8080 --realm master --user admin --password admin</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">./kcadm.sh create realms -s realm=myrealm -s enabled=true -s scimApiEnabled=true</code></pre>
</div>
</div>
<div class="paragraph">
...
When running on <code>localhost</code>, you should see something like <code><a class="bare" href="http://localhost:8080/realms/myrealm/scim/v2">http://localhost:8080/realms/myrealm/scim/v2</a></code> as the SCIM base URL.</p>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">./kcadm.sh create clients -r myrealm -s clientId=scim-client -s serviceAccountsEnabled=true -s publicClient=false -s secret=secret</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">./kcadm.sh add-roles -r myrealm --uusername service-account-scim-client --cclientid realm-management --rolename manage-users
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">ACCESS_TOKEN=$(curl -s -X POST "http://localhost:8080/realms/myrealm/protocol/openid-connect/token" \
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X POST "http://localhost:8080/realms/myrealm/scim/v2/Users" \
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X POST "http://localhost:8080/realms/myrealm/scim/v2/Groups" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/scim+json" \
  -H "Accept: application/scim+json" \
  -d '{
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X PATCH "http://localhost:8080/realms/myrealm/scim/v2/Groups/{group_id}" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/scim+json" \
  -H "Accept: application/scim+json" \
  -d '{
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X GET "http://localhost:8080/realms/myrealm/scim/v2/ServiceProviderConfig" \
  -H "Authorization: Bearer $ACCESS_TOKEN"</code></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X GET "http://localhost:8080/realms/myrealm/scim/v2/Schemas" \
  -H "Authorization: Bearer $ACCESS_TOKEN"</code></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-bash">curl -v -X GET "http://localhost:8080/realms/myrealm/scim/v2/ResourceTypes" \
  -H "Authorization: Bearer $ACCESS_TOKEN"</code></pre>
</div>
</div>
</div>
...
<ul>
<li>
<p><a class="bare" href="https://github.com/keycloak/keycloak/issues/45287">https://github.com/keycloak/keycloak/issues/45287</a></p>
</li>
</ul>
</div>
<div class="paragraph">
